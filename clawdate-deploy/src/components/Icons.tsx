...
export function MessageCircle({ className = '', filled = false }: IconProps) {
  return (
    <svg 
      className={className} 
      viewBox="0 0 24 24" 
...
export function User({ className = '', filled = false }: IconProps) {
  return (
    <svg 
      className={className} 
      viewBox="0 0 24 24" 
...
export function Trophy({ className = '', filled = false }: IconProps) {
  return (
    <svg 
      className={className} 
      viewBox="0 0 24 24" 
...
export function Star({ className = '', filled = false }: IconProps) {
  return (
    <svg 
      className={className} 
      viewBox="0 0 24 24" 
